 ...
 *   
 */
public class JPaymentMagcardManual 
        ...
        implements JPaymentInterface 
{
    ...
    public JPaymentMagcardManual(final JPaymentNotifier _notifier) 
    {
     ...
     */
    @Override
    public void activate(final CustomerInfoExt _customerext, 
                         final double _dTotal, 
                         final String _transID) 
    {
