...
// JG 16 May 12 use diamond inference
    ...
    public class JPaymentCashCreator implements JPaymentCreator {
         ...
         */
        @Override
        public String getIconKey() { return "/uk/chromis/images/cash.png"; }
    }
    ...
    public class JPaymentChequeCreator implements JPaymentCreator {
         ...
         */
        @Override
        public String getIconKey() { return "/uk/chromis/images/cheque.png"; }
    }
    ...
    public class JPaymentPaperCreator implements JPaymentCreator {
         ...
         */
        @Override
        public String getIconKey() { return "/uk/chromis/images/voucher.png"; }
    }
    ...
    public class JPaymentMagcardCreator implements JPaymentCreator {
         ...
         */
        @Override
        public String getIconKey() { return "/uk/chromis/images/ccard.png"; }
    }
    ...
    public class JPaymentFreeCreator implements JPaymentCreator {
         ...
         */
        @Override
        public String getIconKey() { return "/uk/chromis/images/wallet.png"; }
    }
    ...
    public class JPaymentDebtCreator implements JPaymentCreator {
         ...
         */
        @Override
        public String getIconKey() { return "/uk/chromis/images/customer.png"; }
    }
...
// * Bank Payment receipt - Thanks Steve Clough! August 2011
     ...
     */
         ...
         */
        @Override
        public String getIconKey() { return "/uk/chromis/images/bank.png"; }
    }
