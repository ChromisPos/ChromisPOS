        ...
        try {
            ...
            if (oProduct == null) {
                ...
                if (oProduct.isScale() && m_App.getDeviceScale().existsScale()) {
                    try {
                        Double value;
                        value = m_App.getDeviceScale().readWeight();
                ...
                if (executeEvent(ticket, ticketext, "ticket.total") == null) {
                    ...
                    if ( refund || ticket.getTotal() < 0.0 || ticket.getCustomer() != null ) {
                        ...
                        if( val != null && val.isEmpty() == false ) {
                            ...
                            paymentdialog.setPrintSelected(!Boolean.parseBoolean(AppConfig.getInstance().getProperty("till.receiptprintoff")));
                        }
                    }
